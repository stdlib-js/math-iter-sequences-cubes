...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof iterCubesSeq, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an iterator protocol-compliant object which generates a sequence of cubes', function test( t ) {
	var expected;
	var actual;
	var it;
	var i;
	...
	for ( i = 0; i < 1000; i++ ) {
		...
		t.strictEqual( isCubeNumber( actual.value ), true, 'returns a cube number' );
...
tape( 'if an environment supports `Symbol.iterator`, the returned iterator is iterable', function test( t ) {
	...
	iterCubesSeq = proxyquire( './../lib/main.js', {
